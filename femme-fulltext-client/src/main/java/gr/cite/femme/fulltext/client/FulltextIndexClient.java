...
public class FulltextIndexClient implements FulltextIndexClientAPI {
	...
	@Override
	public void insert(String elementId, String metadatumId, Map<String, Object> fields) throws FulltextException {
		...
		Response response = this.target.path("admin").path("elements").request().post(Entity.entity(doc, MediaType.APPLICATION_JSON));
